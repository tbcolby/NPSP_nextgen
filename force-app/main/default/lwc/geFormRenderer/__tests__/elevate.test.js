...
jest.mock("@salesforce/apex/GE_GiftEntryController.addToElevateBatch", () => ({ default: jest.fn() }), {
    virtual: true,
});
jest.mock("@salesforce/apex/GE_GiftEntryController.createElevateBatch", () => ({ default: jest.fn() }), {
    virtual: true,
});
...
const getDummyGift = () => {
    return new ElevateTokenizeableGift("DummyFirstName DummyLastName", 5.0, {
        scheduleTest: "testVal1",
        scheduleTest2: "testVal2",
    });
};
