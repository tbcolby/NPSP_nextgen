...
import getAdvancedMappingFieldsData from "@salesforce/apex/BDI_ManageAdvancedMappingCtrl.getAdvancedMappingFieldsData";
...
const columns = [
    ...
    {
        label: bdiFMUIDataType,
        fieldName: "Source_Field_Display_Type_Label",
        type: "text",
        initialWidth: 125,
        sortable: true,
    },
    {
        label: bdiFMUIDatatableMapsTo,
        fieldName: "",
        type: "text",
        fixedWidth: 95,
    ...
    {
        label: bdiFMUIDataType,
        fieldName: "Target_Field_Display_Type_Label",
        type: "text",
        initialWidth: 125,
        sortable: true,
    },
...
export default class bdiFieldMappings extends LightningElement {
    ...
    init = async () => {
        ...
        try {
            ...
            this.fieldMappings = await getFieldMappingsByObjectAndFieldSetNames({
            ...
            if (this.fieldMappings && this.fieldMappings.length > 0) {
                this.fieldMappings = this.sortData(this.fieldMappings, "Source_Field_Label", "asc");
        ...
        if (this.displayFieldMappings) {
            ...
            this.deploymentTimer = setTimeout(
                function () {
                    ...
                    showToast(bdiFMUILongDeployment, bdiFMUILongDeploymentMessage + " {0}", "warning", "sticky", [
