...
import getGiftEntrySettings from "@salesforce/apex/GE_GiftEntryController.getGiftEntrySettings";
...
const findMissingRequiredFieldMappings = (TemplateBuilderService, formSections) => {
    ...
    let selectedFieldMappingDevNames = formSections
...
const getPageAccess = async () => {
    ...
    const isAdvancedMappingOn =
        dataImportSettings && dataImportSettings[FIELD_MAPPING_METHOD_FIELD_INFO.fieldApiName] === ADVANCED_MAPPING;
