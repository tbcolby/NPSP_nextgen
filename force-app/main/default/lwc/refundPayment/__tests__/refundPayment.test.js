...
jest.mock("@salesforce/apex/PMT_RefundController.processRefund", () => ({ default: jest.fn() }), { virtual: true });

jest.mock("@salesforce/apex/PMT_RefundController.getInitialView", () => ({ default: jest.fn() }), { virtual: true });
